...
{
    public static class AutoAssistantUIHelper
    {
...
#pragma warning restore CA1422
        ...
        public static UIButton CreatePowerPlannerBlueButton(string title)
        {
            ...
            if (OperatingSystem.IsIOSVersionAtLeast(15))
            {
                ...
                config.Background.BackgroundColor = ColorResources.AccentColor;
            ...
            else
            {
                ...
                button.BackgroundColor = ColorResources.AccentColor;
