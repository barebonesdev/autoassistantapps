...
namespace AutoAssistantUWP.Views
{
    ...
    /// </summary>
    public sealed partial class ViewScheduleItemView : PopupViewHostGeneric
    {
        public new ViewScheduleItemViewModel ViewModel
        {
            get { return base.ViewModel as ViewScheduleItemViewModel; }
            set { base.ViewModel = value; }
        }

        public ViewScheduleItemView()
        {
        ...
        {
            ViewModel.ViewRecord(e.ClickedItem as ViewItemMaintenanceRecordEntry);
        }
    }
}
