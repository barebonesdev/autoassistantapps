...
namespace AutoAssistantUWP.Views
{
    public sealed partial class CreateAccountView : PopupViewHostGeneric
    {
        ...
        {
            MessageDialog dialog = new MessageDialog(AutoAssistantResources.GetString("CreateAccountPage_String_WarningOfflineAccountExplanation"), AutoAssistantResources.GetString("CreateAccountPage_String_WarningOfflineAccount"));

            UICommand createCommand = new UICommand(AutoAssistantResources.GetString("String_Create"));
            dialog.Commands.Add(new UICommand(AutoAssistantResources.GetString("String_GoBack")));
            ...
            {
                ViewModel.CreateLocalAccountAsync();
            }
        }
