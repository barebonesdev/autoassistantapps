...
namespace AutoAssistantAppDataLibrary.ViewModels.MainWindow.Settings
{
    public class ChangeEmailViewModel : BaseViewModel
    {
        ...
        private async void Initialize()
        {
            ...
            SetError(AutoAssistantResources.GetString("Settings_ChangeEmailPage_Errors_FailedGrabEmail"));
        }
        ...
        public async void UpdateEmail()
        {
            ...
            {
                SetError(AutoAssistantResources.GetString("Settings_ChangeEmailPage_Errors_FailedUpdateOnline"));
            }
