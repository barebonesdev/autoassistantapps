...
namespace AutoAssistantAppDataLibrary.ViewModels
{
    public class ConfirmDeleteViewModel : PopupComponentViewModel
    {
        ...
        {
            var parent = AutoAssistantApp.Current.GetCurrentWindow().ViewModel.FinalContent.FindAncestorOrSelf<PagedViewModelWithPopups>();
            var viewModel = new ConfirmDeleteViewModel(parent, message, title, "Yes, delete");
