...
namespace AutoAssistantAppDataLibrary.DataLayer
{
    public static class AccountsManager
    {
        ...
        /// <returns></returns>
        public static async Task<AccountDataItem> CreateAccount(string username, string password, long accountId, int deviceId, bool rememberUsername, bool rememberPassword, bool autoLogin)
        {
